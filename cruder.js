...
const app = express()
const port = 7003 //changed port number to avoid conflict with react port number
const cors = require('cors')
const bodyParser = require('body-parser');

//mongodb connection code below
const{ MongoClient} = require('mongodb');
let dbName = 'myDB_praj'
...
app.get('/savedata',(req,res) => {
    ...
    .then((client) => {
        ...
        db.collection(collectionName).insertOne({name: "Sumit Rane",mobile: 9546875932,gender:"male"})
        .then(() => {
